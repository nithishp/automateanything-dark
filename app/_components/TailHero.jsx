...
export default function TailHero() {
  ...
  const words = `2 Automate Anything`

  return (
    <div className="h-[100vh] ">
      <WavyBackground className="max-w-4xl mx-auto py-40 md:py-10">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-700">
                We are a bridge to your success, connecting your dreams to
                reality. We can make your journey to RPA a smooth and enjoyable
                one.
              </p>
